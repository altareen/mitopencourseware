...
# Author:       Alwin Tareen
# Created:      Feb 28, 2022
# Execution:    python3 ps4a_wordgame.py
#
# This program implements a clone of the word game, scrabble
#
##
...
def isValidWord(word, hand, wordList):
    ...
    clone = hand.copy()
    for letter in word:
        if letter in clone and clone[letter] > 0:
            clone[letter] -= 1
        else:
            return False
    return True
...
#
# Problem #4: Calculating hand length
#
    ...
    while calculateHandlen(hand) > 0:
        ...
        # Otherwise (the input is not a single period):
            ...
            # Otherwise (the word is valid):
                ...
                score += current
                print('"' + word + '" earned ' + str(current) + ' points. Total: ' + str(score) + ' points\n')
                # Update the hand 
