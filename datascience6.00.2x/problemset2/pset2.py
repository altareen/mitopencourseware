...
class RectangularRoom(object):
    ...
    def cleanTileAtPosition(self, pos):
        ...
        pos: a Position
        """
        self.room[self.height - 1 - int(pos.getY())][int(pos.getX())] = True
    ...
    def isTileCleaned(self, m, n):
        ...
        """
        return self.room[self.height - 1 - n][m]
    ...
    def getNumCleanedTiles(self):
        ...
        returns: an integer
        """
        return sum(row.count(True) for row in self.room)
